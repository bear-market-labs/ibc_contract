...
initial_lp_holder=$INITIAL_LPER #0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266
initial_reserve=$(cast --to-wei 2 ether)
...
export IBC_IBETH_TOKEN_CONTRACT_ADDRESS=$ibeth_address
